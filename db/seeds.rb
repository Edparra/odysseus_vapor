...
p1 = Product.create!({title:'Staylit Chief Vaporizer Pen Kit', description:'All the essentials needed to operate immediately', pic_url:'http://www.marijuanapackaging.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/s/t/staylit-chief-vaporizer-pen-kit-chrome-0.jpg'})
p2 = Product.create!({title:'Double G Snoop Dogg G Pen', description:'Snoops very own product', pic_url:'http://img.diytrade.com/seimg/2079677/40384550/Double_G_Snoop_Dogg_G_Pen_Herbal_Vaporizer_herbal_tank_Box_Set.jpg'})
p3 = Product.create!({title:'E-Liquid', description:'Sweet flavors to enhance the mood', pic_url:'http://blog.vaporjedi.com/wp-content/uploads/2015/06/mr-good-ejuice.jpg'})
...
p8 = Product.create!({title:'Kangertech Clearomizer Tank', description:'Constructed of Pyrex Glass Stainless Steel ', pic_url:'http://cdn.shopify.com/s/files/1/0400/6105/products/TOPTANK_MINI2.jpg?v=1453767933'})
